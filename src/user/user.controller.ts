import { Body, Controller, Get, NotFoundException, Param, ParseIntPipe, Post, UseGuards, UseInterceptors, ValidationPipe } from '@nestjs/common';
...
export class UserController {
    ...
    @Get()
    @UseInterceptors(new TimeoutInterceptor(100)) 
    getAllUsers() {
